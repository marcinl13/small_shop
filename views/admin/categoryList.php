        ...
        <template x-for="category in categories" :key="category.id">
          <tr>
            ...
            <td class="sm-shop-center">
              <figure x-on:click="edtCategory(category.id)" class="sm-shop-action" data-tooltip="<?php echo SmallShopTranslation::translate('Category_edit'); ?>">
              ...
              <figure x-on:click="delCategory(category.id)" class="sm-shop-action" data-tooltip="<?php echo SmallShopTranslation::translate('Category_delete'); ?>">
